...
### Windows:
Download from: https://github.com/tursodatabase/turso-cli/releases/latest

1. Download `turso-windows-amd64.exe`
2. Rename to `turso.exe`
...
# Create database
turso db create smpi-voucher

# Get database URL
turso db show smpi-voucher --url

# Create auth token
turso db tokens create smpi-voucher
```
...
- Claim: `https://your-app.vercel.app/claim`
- Admin: `https://your-app.vercel.app/gate/v9x3k7m2q8`

---

## 🎉 Done!

Your voucher system is now deployed for FREE on Vercel + Turso!

**Costs:**
- Vercel: $0 (hobby tier)
- Turso: $0 (free tier: 500 MB, 1B row reads/month)
- Total: **$0/month**
...
**Enough for:**
- ~500,000 vouchers
- Plenty for SMPI's needs!

---

## 🔄 Switching Back to SQLite (if needed)

Just revert the changes and deploy to Railway instead. All your code structure remains the same!
